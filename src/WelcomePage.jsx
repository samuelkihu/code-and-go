...
import { BookOpen, Terminal, ArrowRight, Search, Copy, Check } from "lucide-react";
    ...
    <main className="max-w-[1600px] mx-auto px-4">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            <button
              ...
              style={{ background: "#1B4B43", color: "#d6cdc0" }}
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-md font-medium"
              style={{ background: "transparent", color: "#1F2421", border: "1px solid #d4cfbe" }}
            >
              Browse snippets
            </button>
          </div>
          ...
          <div
            className="mt-9 flex items-center gap-2 max-w-sm px-4 py-2.5 rounded-md"
            style={{ background: "#f9f8f5", border: "1px solid #DCD4C2" }}
          >
      ...
      <section className="grid md:grid-cols-2 gap-6 pb-24">
        <IndexCard
          n="002"
          label="Learn"
          icon={<BookOpen size={20} color="#fcf9f4" />}
        ...
        <IndexCard
          n="003"
          label="Snippets"
          icon={<Terminal size={20} color="#f7f6f3" />}
